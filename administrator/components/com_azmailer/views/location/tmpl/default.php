...
<table class="adminlist">
    ...
    <tfoot>
	<tr><td colspan="100"><?php echo $this->pagination->getListFooter(); ?></td></tr>
    </tfoot>
    <tbody>
	<?php
...
<input type="hidden" id="filter_location_type" name="filter_location_type" value="<?php echo $this->state->get('filter.location_type'); ?>" />
	...
	jQuery('#mDialog').dialog( "option", "buttons", [
            ...
            click: function() {
                ...
                jQuery.post("index.php", {
                    ...
                    function(data){elaborateJsonResponse(data, true, "location.display");}
                );
            }},
            {
