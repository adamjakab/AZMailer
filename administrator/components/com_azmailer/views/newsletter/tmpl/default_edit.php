...
<div id="tabs">
	...
	<div id="tab-1" style="padding:0;">
		<div class="ui-widget-content">
			...
			<table class="adminlist displaytable" name="nl_data">
				<tr>
					<td style="text-align:right; font-weight:bold;"><a title="<?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_MOD_TITLE'); ?>" href="#" onClick="changeNewsletterTitle();"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_TITLE'); ?>:</a></td><td align="left" name="nl_title"><?php echo $TITLE;?></td>
					<td style="text-align:right; font-weight:bold;"><a title="<?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_MOD_TITLE'); ?>" href="#" onClick="changeNewsletterTitle();"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_TITLE_INTERNAL'); ?>:</a></td><td align="left" name="nl_title_internal"><?php echo $TITLE_INTERNAL;?></td>
					<td style="text-align:right; font-weight:bold;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_CREATION_DATE'); ?>:</td><td align="left"><?php echo $CREATION_DATE;?></td>
				</tr>
				<tr>
					<td style="text-align:right; font-weight:bold;"><a title="<?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_MOD_SENDER'); ?>" href="#" onClick="changeNewsletterSender();"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_SENDER'); ?>:</a></td><td align="left" name="nl_sender"><?php echo $SENDER;?></td>
					<td style="text-align:right; font-weight:bold;"><a title="<?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_MOD_SENDER'); ?>" href="#" onClick="changeNewsletterSender();"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_SENDER_NAME'); ?>:</a></td><td align="left" name="nl_sender_name"><?php echo $SENDER_NAME;?></td>
					<td style="text-align:right; font-weight:bold;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_SEND_DATE'); ?>:</td><td align="left"><?php echo $SEND_DATE;?></td>
				</tr>
			</table>
	...
	<div id="tab-2" style="padding:0;">
		<div class="ui-widget-content">
			...
			<textarea name="nltxt" style="width:100%; height:450px; "><?php echo $item->get("nl_textversion"); ?></textarea>
		</div>
	</div>
	...
	<div id="tab-4" style="padding:0;">
		<h2 class="ui-widget-header">
			...
			<div style="float:right;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_NUM_RECIEVERS');?>:&nbsp;<span name="numberOfRecepients">0</span></div>
		</h2>
		<div class="ui-widget-content halfsize lefty">

			<h3 class="ui-widget-header" style="height:25px;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_SEL_GEOPOS');?></h3>
			<fieldset name="locSelBehaviourDesc">
				...
				<table width="100%" cellpadding="1" cellspacing="0">
					<tr>
						...
						<td><select style="min-width:200px;" size="1" class="inputbox" id="nls_country_id" name="nls_country_id"></select></td>
					</tr>
					<tr>
						<td><?php echo JText::_('COM_AZMAILER_LOCATION_REGION');?>:</td>
						<td><select style="min-width:200px;" size="1" class="inputbox" id="nls_region_id" name="nls_region_id"></select></select></td>
					</tr>
					<tr>
						<td><?php echo JText::_('COM_AZMAILER_LOCATION_PROVINCE');?>:</td>
						<td><select style="min-width:200px;" size="1" class="inputbox" id="nls_province_id" name="nls_province_id"></select></td>
					</tr>
				</table>
			</fieldset>


			<h3 class="ui-widget-header behaveSel" style="height:25px;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_SEL_BEHAVIOUR');?>
			...
			<h3 class="ui-widget-header" style="height:25px;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_SEL_CATEGORY');?>
				<a name="cat_selection_reset" style="float:right;width:16px; height:16px;cursor:pointer; margin:5px 2px 2px 2px;" class="ui-icon ui-icon-cancel" title="<?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_UNSELECT_ALL_CATEGORIES');?>"></a>
			</h3>
		...
		<div class="ui-widget-content halfsize righty">
			<h3 class="ui-widget-header" style="height:25px;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_ADDITIONAL_RECIPIENTS');?>
				<a name="xls_upload" style="float:right;width:16px; height:16px;cursor:pointer; margin:2px;" class="ui-icon ui-icon-circle-plus" title="<?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_UPLOAD_XLS');?>"></a>
				<a name="additional_cnt_remove" rel="all" style="float:right;width:16px; height:16px;cursor:pointer; margin:2px;" class="ui-icon ui-icon-circle-minus" title="<?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_ADDITIONAL_RECIPIENTS_REMOVE_ALL');?>"></a>
			</h3>
			<div class="ui-widget-content">
				<ul id="NL_additional"></ul>
			</div>

			<h3 class="ui-widget-header" style="height:25px;"><?php echo JText::_('COM_AZMAILER_NEWSLETTER_TIT_GEO_CAT_RECIPIENTS');?></h3>
			<div class="ui-widget-content">
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<input type="hidden" name="nl_template_substitutions" value="<?php echo $item->get("nl_template_substitutions"); ?>" />
...
<style type="text/css">
	...
	ul#NL_additional li div.nla_mail, ul#NL_catselects li div.nla_mail{
		float:left; width:50%; border-right:1px solid #9CB1B8; margin-right:5px;
	}
