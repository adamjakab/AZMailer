...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="adminForm" id="adminForm">
    <fieldset id="filter-bar">
        <div class="filter-search fltlft">
            <input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_AZMAILER_SEARCH'); ?>" placeholder="<?php echo JText::_('COM_AZMAILER_SEARCH'); ?>" />
    ...
    <table class="adminlist">
        <thead>
            <tr>
		        <th style="width:1%;"><input type="checkbox" name="checkall-toggle" value="" title="<?php echo JText::_('COM_AZMAILER_CHECK_ALL'); ?>" onclick="Joomla.checkAll(this)"/></th>
	...
	Joomla.submitbutton = function (pressbutton) {
		...
		if (pressbutton == 'checkmail') {
			jQuery.fancybox({
				...
				height:600,
				modal: true,
				onClosed: function() {window.location.href = 'index.php?option=<?php $AZMAILER->getOption("com_name"); ?>&task=subscriber.display';}
			});
			return(false);
		}
