...
<fieldset class="adminform">
    ...
    <table class="adminlist edittable" style="width:100%;">
	    ...
	    <tr>
		    ...
		    <td class="data_val">
			    <input class="inputbox" type="file" name="nls_contacts_file" id="nls_contacts_file" size="50" value="" />
		    </td>
	    </tr>
	    ...
	    <tr>
		    ...
		    <td>
			    <table width="100%" border="0">
				    <tr><td style="height:auto; padding:0;">
						    <input class="inputbox" type="radio" name="nls_overwrite_existing" value="1" style="margin:0 3px;"/>
						    <?php echo JText::_("COM_AZMAILER_SUBSCR_IMPORT_OVERWRITE_OP1"); ?>
					</td></tr>
				    <tr><td style="height:auto; padding:0;">
						    <input class="inputbox" type="radio" name="nls_overwrite_existing" value="2" style="margin:0 3px;"/>
						    <?php echo JText::_("COM_AZMAILER_SUBSCR_IMPORT_OVERWRITE_OP2"); ?>
					</td></tr>
				    <tr><td style="height:auto; padding:0;">
						    <input class="inputbox" type="radio" name="nls_overwrite_existing" value="3" checked="checked" style="margin:0 3px;"/>
	    ...
	    <tr bgcolor="#efefef">
		    <td class="data_name" style="vertical-align: top;"><label><?php echo JText::_("COM_AZMAILER_SUBSCR_GEOPOS"); ?></label></td>
		    <td class="data_val">
			    <table width="100%" border="0">
				    <tr>
	    ...
	    <tr bgcolor="#efefef">
		    <td class="data_name" style="vertical-align: top;">
			    <?php echo JText::_("COM_AZMAILER_SUBSCR_IN_CATEGORY"); ?><br /><br /><em><?php echo JText::_("COM_AZMAILER_SUBSCR_IN_CATEGORY_HELP"); ?></em>
		    </td>
		    <td class="data_val">
			    <table width="100%" border="0">
				    <tr>
...
<script language="javascript" type="text/javascript">
	...
	function checkFormData(pressbutton) {
		...
		jQuery('form#adminForm').ajaxSubmit({
			data:               {option:"<?php echo $AZMAILER->getOption("com_name"); ?>", task:"subscriber.importSubscribers", format:"raw"},
			dataType:           'json',
		...
		mDialog.dialog("option", "buttons", [
				{
					...
					click: function() { mDialog.dialog("close"); }
				}
			]
		);
	}
